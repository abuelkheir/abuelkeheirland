...
void DIO_u8SetPinValue(u8 Copy_PortX,u8 Copy_PinX, u8 Copy_value); // function used to set the value of the port
...
void DIO_vidSetPortValue(u8 Copy_PortX, u8 Copy_Direction);

void DIO_vidTogglePinValue(u8 Copy_PortX,u8 Copy_Value);
